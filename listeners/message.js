...
class MessageListener extends Listener {
  ...
  exec(message) {
    ...
    else if (message?.channel?.id == "828155824966205440" && message.author != this.client.user && !(["appeal", "approve", "accept", "compromise", "comp", "deny", "reject", "counter"].includes(message.content.split(" ")[0].slice(1)) && message.content.split(" ")[0].charAt(0) == prefix)) {
